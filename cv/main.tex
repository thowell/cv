...
\section*{Summary}
\noindent {\color{lightgray} I am an engineer and researcher interested in high-performance numerical optimization and its applications to simulation, control, robotics, and machine learning.}
...
\noindent[\href{https://github.com/thowell/CALIPSO.jl}{CALIPSO.jl}] {\color{lightgray} solver for non-convex optimization problems conic and complementarity constraints}

\noindent[\href{https://github.com/dojo-sim/Dojo.jl}{Dojo.jl}] {\color{lightgray} differentiable physics engine for rigid-body dynamics with contact}

\noindent[\href{https://github.com/RoboticExplorationLab/TrajectoryOptimization.jl}{TrajectoryOptimization.jl}] {\color{lightgray} tool for fast trajectory optimization}
